...
public class AppearanceListAdapter extends ArrayAdapter<String>{
    ...
    public AppearanceListAdapter(Context c, String[] objects){
        super(c,R.layout.appearance_listitem,objects);
        _context = c;
        _items = objects;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.appearance_listitem,null,true);
        ViewHolder holder = new ViewHolder();
        holder.title= (TextView) rowView.findViewById(R.id.aTitle);
